...
def resultado(request):
    ...
    bop_query = Q(data_fato__date=boletim['dataFato']) & Q(data_registro__date=boletim['dataRegistro']) & Q(registro=boletim['registro']) & Q(relato__icontains=boletim['relato'])
